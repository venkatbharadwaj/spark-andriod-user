...
public class CarouselAutomaticPagerAdapter extends FragmentPagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public CarouselAutomaticPagerAdapter(HomeActivity context, FragmentManager fm) {
        super(fm);
        this.fragmentManager = fm;
        this.context = context;
    }

    public CarouselAutomaticPagerAdapter(HomeActivity context, FragmentManager fragmentManager, ArrayList<ParkingDetails> parkingDetailsArrayList) {
    ...
    public int getCount() {
      /*  int count = 0;
        ...
        return count;*/
        if (parkingDetailsArrayList != null) {
