package com.aadyasystemsllc.spark.customviews;
...
public class SnackBar {
    ...
    public com.google.android.material.snackbar.Snackbar getSnackBar() {
        ...
        TextView txtTitle = (TextView) sbView.findViewById(R.id.snackbar_text);
        TextView txtAction = (TextView) sbView.findViewById(R.id.snackbar_action);
